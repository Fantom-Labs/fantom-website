...
// fala"), herdando cor via currentColor. Extraído de liquid-metal-button.tsx
// (era privado ali) pra reaproveitar no CTA da section 4 (ver metodo.tsx,
// ShinyButton "Falar com a Fantom") sem duplicar o path.
