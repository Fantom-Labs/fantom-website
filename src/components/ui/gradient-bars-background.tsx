...
// cor padrão trocada de laranja (rgb(255,60,0), original do componente
// colado) pro azul da marca (#3448ff, mesmo tom já usado no indicador da
// badge "O QUE FAZEMOS").
export function GradientBars({
  numBars = 15,
  gradientFrom = "rgb(52, 68, 255)",
