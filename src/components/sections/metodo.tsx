...
export function MetodoCard() {
  return (
    <CardFrame>
      {/* text-center (heading/parágrafo) + justify-center no badge —
          pedido explícito: "o conteúdo da section 4 deve ser centralizado"
          (o design de referência tem badge/heading/parágrafo centrados,
          diferente do ServiceCard, alinhado à esquerda). Badge: mesmo
          design do ServiceCard (pedido explícito: "deixe o design do
          badge da section 4 igual ao da section 3") — dot quadrado azul +
          label, não mais a pílula com borda da primeira versão. */}
      ...
      <div className="mt-8 grid flex-1 grid-cols-1 gap-4 sm:grid-cols-3 sm:gap-6">
