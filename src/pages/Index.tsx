...
const Index = () => {
  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div 
        className="absolute top-0 left-0 right-0 h-[calc(100vh-10rem)] z-0"
        style={{
      ...
      <div className="relative z-10">
        <div className="flex flex-col items-center justify-center min-h-[calc(100vh-10rem)] px-4 text-center pt-20">
