    ...
    <div className="relative min-h-screen">
      ...
      <div className="relative z-10">
        ...
        >
          ...
          <h1 className="text-[56px] font-bold mb-6 bg-gradient-to-r from-[#8B5CF6] via-[#D946EF] to-[#F97316] bg-clip-text text-transparent bg-[size:200%_200%] animate-gradient leading-[120%]">
