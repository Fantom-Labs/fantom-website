    ...
    <div className="relative min-h-screen">
      ...
      <div className="relative z-10">
        ...
        >
          ...
          <h1 className="text-[48px] md:text-[56px] font-bold mb-6 bg-gradient-to-r from-[#0033FF] via-[#E9E9E9] to-[#7F92F3] bg-clip-text text-transparent bg-[size:200%_200%] animate-gradient leading-[120%] relative max-w-3xl scale-115 mx-auto px-10 py-12 rounded-xl bg-black/30 shadow-[0_0_20px_rgba(0,0,0,0.3)]">
